...
public class PPM {
	 ...
	 * <p>
	 * The stream must contain a binary PPM (type P6 in the header) of 255
	 * colors
	 * 
	 * @param filename
	 *            The name of the file to read the PPM from
	 * @throws IOException
	...
	public PPM(String filename) throws IOException, UnsupportedEncodingException {
		 ...
		 * PPM file format:
		 * 
		 * # --> Comments allowed anywere before binary data P3|P6 -->
		 * ASCII/Binary WIDTH --> image width, in ascii HEIGHT --> image height,
		 * in ascii COLORS --> num colors, in ascii [data] --> if P6, data in
		 * binary, 3 RGB bytes per pixel
		 */
